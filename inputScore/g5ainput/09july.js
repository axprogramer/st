      ...
      AllRecords.forEach(
        function (CurrentRecord) {
          ...
          addItemsToTable(name, id, sex, speakingjuly, writingjuly, listeningjuly,
            readingjuly, averagejuly, myKh,score,hJul);
          showAuto();
          b = 1;
...
function addItemsToTable(name, id, sex, speakingjuly, writingjuly, listeningjuly,
  ...
  if (speakingjuly == undefined) {
    ...
    td4.innerHTML = speakingjuly;
  }
  if (writingjuly == undefined) {
    td5.innerHTML = 0;
  } else {

    td5.innerHTML = writingjuly;
  }
  if (listeningjuly == undefined) {
    td6.innerHTML = 0;
  } else {

    td6.innerHTML = listeningjuly;
  }
  if (readingjuly == undefined) {
    td7.innerHTML = 0;
  } else {

    td7.innerHTML = readingjuly;
  }
  if (hJul == undefined) {
    td8.innerHTML = 0;
  } else {
  ...
  const sleep = async (milliseconds) => {
    ...
    //Sum all score
    let to1 = parseFloat(speakingjuly)
      + parseFloat(writingjuly)
      + parseFloat(listeningjuly)
      + parseFloat(readingjuly)
      + parseFloat(hJul);
    let sub = to1 / 5;
    ...
    if (db4 == ll) {
      ...
      ss.addEventListener('input', () => {
        ...
        td6.innerHTML = di;
        td7.innerHTML = di;
        let to1 = parseFloat(data) + parseFloat(hJul);
        let sum = to1 / 5;
      ...
      ss.addEventListener('input', () => {
        ...
        let toto = parseFloat(data) + parseFloat(speak) + parseFloat(hJul);
