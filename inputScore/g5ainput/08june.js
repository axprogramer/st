...
function addItemsToTable(name, id, sex, speakingjun, writingjun, listeningjun,
  ...
  if (speakingjun == undefined) {
    ...
    td4.innerHTML = speakingjun;
  }
  if (writingjun == undefined) {
    td5.innerHTML = 0;
  } else {

    td5.innerHTML = writingjun;
  }
  if (listeningjun == undefined) {
    td6.innerHTML = 0;
  } else {

    td6.innerHTML = listeningjun;
  }
  if (readingjun == undefined) {
    td7.innerHTML = 0;
  } else {

    td7.innerHTML = readingjun;
  }
  if (hJun == undefined) {
    td8.innerHTML = 0;
  } else {
  ...
  const sleep = async (milliseconds) => {
    ...
    //Sum all score
    let to1 = parseFloat(speakingjun)
      + parseFloat(writingjun)
      + parseFloat(listeningjun)
      + parseFloat(readingjun)
      + parseFloat(hJun);
    let sub = to1 / 5;
    ...
    if (db4 == ll) {
      ...
      ss.addEventListener('input', () => {
        ...
        td6.innerHTML = di;
        td7.innerHTML = di;
        let to1 = parseFloat(data) + parseFloat(hJun);
        let sum = to1 / 5;
      ...
      ss.addEventListener('input', () => {
        ...
        let toto = parseFloat(data) + parseFloat(speak) + parseFloat(hJun);
